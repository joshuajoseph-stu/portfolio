...
function applyFavicon(theme: Theme) {
  const selectors: Record<string, string> = {
    "link[rel='icon'][type='image/x-icon']": `/favicons/${theme}/favicon_${theme}.ico`,
    "link[rel='icon'][sizes='16x16']": `/favicons/${theme}/favicon_${theme}-16x16.png`,
    "link[rel='icon'][sizes='32x32']": `/favicons/${theme}/favicon_${theme}-32x32.png`,
    "link[rel='apple-touch-icon']": `/favicons/${theme}/apple-touch-icon_${theme}.png`,
  };
